...
/***/ (function(module, exports, __webpack_require__) {
	...
	// Beer
	var onAddBeer = function onAddBeer(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.addBeer(data).then(ui.addBeerSuccess).catch(ui.addBeerFailure);
	};

	var onUpdateBeer = function onUpdateBeer(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.updateBeer(data).then(ui.updateBeerSuccess).catch(ui.updateBeerFailure);
	};

	var onDeleteBeer = function onDeleteBeer(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.deleteBeer(data).then(ui.deleteBeerSuccess).catch(ui.deleteBeerFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var beerIndex = function beerIndex(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/beers',
	    method: 'GET',
	    headers: {
	...
	var deleteBeer = function deleteBeer() {
	  return $.ajax({
	    url: config.apiOrigin + '/beers/' + store.beerId,
	    method: 'DELETE',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// Beer
	var showBeersTemplate = __webpack_require__(13);
	var beerFormTemplate = __webpack_require__(33);
	var beerDeleteTemplate = __webpack_require__(34);

	var reloadBeerList = function reloadBeerList() {
	  api.beerIndex().then(beerIndexSuccess).catch(beerIndexFailure);
	};
	...
	var emptyAddForm = function emptyAddForm() {
	  $('.name-add').val('');
	  $('.brand-add').val('');
	  $('.style-add').val('');
	  $('.alc-add').val('');
	...
	var openBeerForm = function openBeerForm(event) {
	...
	var confirmBeerDelete = function confirmBeerDelete(event) {
	  store.beerId = $(event.target).closest('td').data('id');
	};

	var beerIndexSuccess = function beerIndexSuccess(response) {
	  $('.beerList').empty();
	  var showBeersHtml = showBeersTemplate({ beers: response.beers });
	  $('.beerList').append(showBeersHtml);
	  $('.openBeerUpdate').on('click', openBeerForm);
	  $('.openDeleteBeerModal').on('click', confirmBeerDelete);
	};

	var beerIndexFailure = function beerIndexFailure(error) {
	...
	module.exports = {
	  ...
	  // Beer
	  beerIndexSuccess: beerIndexSuccess,
	  beerIndexFailure: beerIndexFailure,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<tr>\n  <td class=\"col-xs-2\" align=\"center\" data-id=\""
	    ...
	    + "\">\n    <a class=\"btn btn-default openBeerUpdate\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-toggle=\"modal\" data-target=\"#updateBeerModal\"><em class=\"fa fa-pencil\"></em></a>\n    <a class=\"btn btn-danger openDeleteBeerModal\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-toggle=\"modal\" data-target=\"#deleteBeerModal\"><em class=\"fa fa-trash\"></em></a>\n  </td>\n  <td class=\"col-xs-2\" data-type=\""
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "</td>\n"
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.brand : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n"
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.style : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n"
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.alc : stack1),{"name":"if","hash":{},"fn":container.program(8, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n"
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.price : stack1),{"name":"if","hash":{},"fn":container.program(10, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</tr>\n";
	},"2":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

	  return "    <td class=\"col-xs-2 brand\" data-type=\""
	  ...
	  return "    <td class=\"col-xs-2 style\" data-type=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.style : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.style : stack1), depth0))
	    + "</td>\n";
	  ...
	  return "    <td class=\"col-xs-1 alc\" data-type=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.alc : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.alc : stack1), depth0))
	    + "</td>\n";
	  ...
	  return "    <td class=\"col-xs-1 price\" data-type=\""
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<form id=\"updateBeer\" data-id=\""
	    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.beer : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n\n  <div class=\"form-group\">\n    <label>Name:</label>\n    <input type=\"text\" name=\"[beer][name]\" placeholder=\"Name\" class=\"form-control name\">\n  </div>\n\n  <div class=\"form-group\">\n    <label>Brand:</label>\n    <input type=\"text\" name=\"[beer][brand]\" placeholder=\"Brand\" class=\"form-control brand\">\n  </div>\n\n  <div class=\"form-group\">\n    <label>Style:</label>\n    <input type=\"text\" name=\"[beer][style]\" placeholder=\"Style\" class=\"form-control style\">\n  </div>\n\n  <div class=\"form-group\">\n    <label>Alc Content:</label>\n    <input type=\"number\" name=\"[beer][alc]\" placeholder=\"Alc Content\" class=\"form-control alc\" min=\"1\">\n  </div>\n\n  <div class=\"form-group\">\n    <label>Price:</label>\n    <input type=\"number\" name=\"[beer][price]\" placeholder=\"Price\" class=\"form-control price\" min=\"1\">\n  </div>\n  <input type=\"submit\" class=\"button btn btn-default\" name=\"submit\" value=\"Update Beer\">\n\n</form>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<div class=\"deleteBeerConfirm\" data-id=\""
	    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.beer : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n  <p>Are you sure you want to delete this beer?</p>\n  <button id=\"deleteBeer\" class=\"btn btn-default button\">Delete Beer</button>\n</div>\n";
	},"useData":true});
